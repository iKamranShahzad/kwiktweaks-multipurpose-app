        ...
        <div className="bg-white p-8 rounded-lg shadow-2xl max-w-4xl w-full transition-shadow duration-300 hover:shadow-xl">
          <div className="mb-6">
            ...
            <input
              ...
              className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline transition-colors duration-300 hover:bg-gray-50"
            />
          </div>
          <div className="mb-6">
            <label
